<template>
  <router-link to="/" class="logo link">
    <svg id="logoShape" width="85" height="46" viewBox="0 0 85 46" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
